...
import appPreviewImage from '../assets/app-nlw-bola-preview.png'
import logoImg from '../assets/logo.svg'
import usersAvatarsExample from '../assets/users-avatar-example.png'
    ...
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
      <main>
        ...
        <div className='mt-10 flex items-center gap-2'>
          <Image src={usersAvatarsExample} alt='' />
